...
// console.log(eat)
var _a = getPerson(), myname = _a.xingMing, food = _a.eat.food;
console.log(myname);
console.log(food);
var arr = [1, 2, 3, 4];
var num1 = arr[2], num2 = arr[3];
var num3 = arr[0], num4 = arr[1], other = arr.slice(2);
function getNum(_a) {
    var num3 = _a[0], num4 = _a[1], other = _a.slice(2);
    console.log(num3);
    console.log(num4);
    console.log(other);
}
